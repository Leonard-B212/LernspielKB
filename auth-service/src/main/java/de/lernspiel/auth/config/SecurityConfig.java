    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                "/debug/create-test-user", "/debug/list-users", "/debug/drop-user", "/debug/login", "/sandbox.html", "/game/interpreter/run", "/level.html", "/skilltree.html").permitAll() // Öffentliche Endpunkte
